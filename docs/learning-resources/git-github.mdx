...
Git and GitHub make all of this possible.
...
It records changes made to files over time, which means you can return to earlier versions, compare edits, and manage project progress more safely.
...
It helps you store your projects online and makes collaboration easier.
...
Your username is important because it becomes part of your GitHub identity, so choose something professional and easy to keep long term.

Try to avoid usernames that feel too informal if you plan to use GitHub for internships, projects, or professional portfolios.
...
Email verification is important because it helps secure your account and enables full use of GitHub features.
...
It is a very good idea to enable **two-factor authentication (2FA)** on your GitHub account.
