...
In the last lesson, you started thinking about student exam scores as data.

Now imagine that instead of just a few rows, you have an entire class dataset with names, scores, and other details. Looking at that information one cell at a time would be slow and difficult. You would need a better way to organize, explore, and summarize the data.
...
Do not worry if this feels new. In the next lessons, you will learn how to read real datasets into DataFrames step by step.
...
Now that you know what Pandas is, the next step is to learn how to install and import libraries more confidently in your notebooks.