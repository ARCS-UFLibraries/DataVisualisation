...
You have cleaned and prepared the Students Performance dataset.
...
Using the Students Performance dataset, calculate:
...
This summarizes **every** numeric column, which may be more than you need. If you only want mathematics scores, use:
