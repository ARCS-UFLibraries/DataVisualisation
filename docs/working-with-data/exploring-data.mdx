  ...
  items={[
    {
      ...
      description: 'Explore the StudentsPerformance dataset using Pandas.',
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/exploring_dataset_lesson.ipynb',
      label: 'Notebook'
    }
  ]}
/>
<ColabActivity pageId="exploring-data" />
...
- How to inspect a dataset using `head()`, `tail()`, `info()`, `describe()`, `shape`, `columns`, and `isnull().sum()`.  
