  ...
  items={[
    {
      ...
      description: 'Practice exporting DataFrames to CSV and Excel.',
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/exporting_data_lesson.ipynb',
      label: 'Notebook'
    }
  ]}
/>
<ColabActivity pageId="exporting-data" />
