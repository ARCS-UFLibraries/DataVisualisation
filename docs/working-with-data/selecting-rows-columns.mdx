...
The Students Performance dataset contains many columns, but most analysis questions focus on just a few of them.
...
Using the Students Performance dataset, perform the following tasks:
