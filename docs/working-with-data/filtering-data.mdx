  ...
  items={[
    {
      ...
      description: 'Follow along with the filtering data lesson notebook.',
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/filtering_data_lesson.ipynb',
      label: 'Notebook'
    }
  ]}
/>
<ColabActivity pageId="filtering-data" />
