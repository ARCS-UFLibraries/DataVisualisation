  ...
  items={[
    {
      ...
      description: 'Create and customize your first Matplotlib line charts.',
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/matplotlib_basics_lesson.ipynb', // replace with your actual notebook URL
      label: 'Notebook'
    }
  ]}
/>

<ColabActivity pageId="matplotlib-basics" />
