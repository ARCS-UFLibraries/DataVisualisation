...
You have already learned how to load data, clean it, and summarize it.

But numbers in a table do not always make patterns easy to see. If you want to understand trends, compare groups, or communicate findings clearly, you need something more visual.

That is where data visualisation comes in.
...
Raw tables are important, but they can be difficult to interpret quickly.
...
Data visualisation is the process of representing data using visual forms such as charts, graphs, and plots.

Instead of reading hundreds of rows one by one, you can use a chart to quickly understand:
...
These four question types will guide much of this module.

As you learn each chart type, you should always ask: **What question is this chart helping me answer?**

### Comparison

A comparison chart helps you compare values across categories.
...
Bar charts are commonly used for comparison because they make it easy to compare category heights.

When reading a comparison chart, pay attention to:
...
A trend chart helps you see how data changes over time or across an ordered sequence.
...
Line charts are commonly used for trends because they show movement across an ordered axis.

When reading a trend chart, ask:
...
A distribution chart helps you understand how values are spread.
...
Histograms and boxplots are useful for distribution.

When reading a distribution chart, ask:
...
A relationship chart helps you explore how two numerical variables behave together.
...
Scatter plots are especially useful here.
...
Creating a plot is only part of the job.

You also need to **read and interpret** what the chart shows. A simple way to do that is to follow this process:
...
Imagine a bar chart showing average mathematics score by gender.
...
Imagine a histogram of reading scores.
...
One of the most common mistakes in data visualisation is choosing a chart that does not match the question.
...
Good analysts do not start by asking, “Which chart looks nice?”  
They start by asking, “What am I trying to show?”

### Google Colab Activity

Open your Students Performance dataset in Google Colab.

Then answer these questions in writing before making any charts:
