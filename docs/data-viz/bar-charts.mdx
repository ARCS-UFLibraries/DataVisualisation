...
Many real analytical questions involve categories rather than continuous time or numerical relationships.
...
Bar charts make these comparisons easy to understand because the length or height of each bar represents the value for one category. They are one of the most common ways to compare categorical data. 
### What Is a Bar Chart?
...
avg_writing_scores =[4][5][6][7][8][9]
