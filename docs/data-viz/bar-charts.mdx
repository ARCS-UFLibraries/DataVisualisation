...
import ColabActivity from '@site/src/components/ColabActivity/ColabActivity';
  ...
  items={[
    {
      ...
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/bar_charts_lesson.ipynb', 
      label: 'Notebook',
    },
  ]}
/>
<ColabActivity pageId="bar-charts" />
