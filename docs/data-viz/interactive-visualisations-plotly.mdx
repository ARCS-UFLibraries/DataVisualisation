...
df = pd.DataFrame({
    "reading_score": [60, 68, 72, 75, 81, 88],
    "writing_score": [58, 66, 70, 74, 83, 90],
    "student": ["A", "B", "C", "D", "E", "F"]
})
...
df = pd.DataFrame({
    "reading_score": [60, 68, 72],
    "writing_score": [58, 66, 70],
    "student": ["A", "B", "C"],
    "group": ["G1", "G1", "G2"]
})
  ...
  items={[
    {
      ...
      href: 'https://colab.research.google.com/github/YOUR-USERNAME/YOUR-REPO/blob/main/notebooks/interactive-visualisations-plotly.ipynb',
      label: 'Notebook',
    },
  ]}
/>
