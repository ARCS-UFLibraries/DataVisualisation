  ...
  items={[
    {
      ...
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/line_charts_lesson.ipynb', // replace with your actual notebook URL
      label: 'Notebook',
    },
  ]}
/>
<ColabActivity pageId="line-charts" />
