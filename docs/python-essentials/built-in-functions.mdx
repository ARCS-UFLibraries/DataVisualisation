  ...
  items={[
    {
      ...
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/built_in_functions_lesson.ipynb',
      label: 'Notebook'
    }
  ]}
/>

<ColabActivity pageId="built-in-functions" />
