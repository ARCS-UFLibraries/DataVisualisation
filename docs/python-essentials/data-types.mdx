...
Data analysis depends on working with values in the right form. If Python thinks a number is text, or text is being treated like a number, the result can be confusing or incorrect.

As you move through this course, you will work with names, scores, categories, dates, and measurements. Learning data types now will make it easier to clean data, analyze patterns, and build visualizations later.
...
Now create variables for the following:
...
Print both the value and the data type of each variable.
