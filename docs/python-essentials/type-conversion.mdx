  ...
  items={[
    {
      ...
      href: 'https://colab.research.google.com/github/ARCS-UFLibraries/Coding-Notebooks/blob/main/type_conversion_lesson.ipynb',
      label: 'Notebook'
    }
  ]}
/>

<ColabActivity pageId="type-conversion" />
