...
As programs grow, repeated code becomes difficult to manage. Functions help you write cleaner, shorter, and more organized programs by grouping related steps together.

In data analysis, functions are useful when you want to:

- repeat the same calculation,
- reuse code on different inputs,
- make notebooks easier to read,
- and break larger problems into smaller steps.
